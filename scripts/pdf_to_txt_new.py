...
def _postprocess_songs(full_text: str) -> str:
    ...
    From page 5 onwards:
      ...
      - Song title (first line after a column-1 marker) is kept unconditionally.
      - Lines with no alphabetic characters are kept (tab notation / numbers).
      - Colon-lines are kept only if they are structural markers.
      - All other alpha lines are dropped (lyrics, Text:, Video:, URLs ...).
    """
